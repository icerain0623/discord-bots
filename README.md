...
| 検閲（ジョーク） | メッセージを1984風に検閲するコンテキストメニュー | ✅ 稼働中 | [詳細](docs/censor.md) |
| 組織図自動編成 | Discordロールから組織図を自動構成しEmbed表示 | 🧪 テスト機能 | [詳細](docs/org.md) |
| 1文リレー | イベント用1文リレー機能（匿名全文投稿＋ネタバレ） | ✅ 稼働中 | [詳細](docs/relay.md) |
| お祝い保存 | メッセージを専用チャンネルにアーカイブ（コンテキストメニュー） | 🧪 テスト機能 | [詳細](docs/celebration.md) |
| タスク管理 | ロールベースのタスク作成・完了・削除 | ✅ 稼働中 | [詳細](docs/task.md) |
| 肩書コイン経済 | サーバー内通貨（参加者管理・銀行・スロット） | 🧪 テスト機能 | [詳細](docs/economy.md) |
| じゃんけんPvP | 肩書コインを賭けて他ユーザーと1対1のじゃんけん対戦 | 🧪 テスト機能 | [詳細](docs/janken.md) |
